...
def clasificar_transaccion_tipo(tipo_transaccion, lista, contenido, sms):
        ...
        for sms in raiz.findall('sms'):
            if fecha_actual.strftime('%Y') in sms.get('readable_date'):
                if definir_nombre_mes(fecha_actual) in sms.get('readable_date') or fecha_actual.strftime('%B') in sms.get('readable_date'):
                    ...
                    clasificar_transaccion_tipo('Pago productos', pago_productos_pse, cuerpo, sms)
                    clasificar_transaccion_tipo('Retiro', retiros, cuerpo, sms)
                    clasificar_transaccion_tipo('Retiro - Sin tarjeta', retiros_sin_tarjeta, cuerpo, sms)
                    clasificar_transaccion_tipo('realizo una transferencia', transferencias, cuerpo, sms)
                    clasificar_transaccion_tipo('realizo Compra', compras, cuerpo, sms)
                    clasificar_transaccion_tipo('consignacion', consignaciones, cuerpo, sms)
